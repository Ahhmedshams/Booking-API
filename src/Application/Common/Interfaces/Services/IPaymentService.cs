...
namespace Application.Common.Interfaces.Services
{
    ...
    {
        public Task<string> MakePayment(IPayemntTransactionRepository paymentTransactionRepository , IBookingItemRepo bookingItemRepo,decimal amount, int bookingID);
